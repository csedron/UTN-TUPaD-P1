...
lista_personal = [3, 6 ,9 , 12 ,15]
print(lista_personal[-2])
...
# respectivamente. Imprimir la lista resultante por pantalla. ¡Puedes hacerlo como se muestra en los videos o bien
...
print(numeros)
#el programa mediante el metodo remove y la funcion max, elimina el numero mayor de la lista
...
# Ejercicio 7: Reemplazar los dos valores centrales (índices 1 y 2) de la lista “autos” por dos nuevos
...
# Ejericio 8: Crear una lista vacía llamada "dobles" y agregar el doble de 5, 10 y 15 usando append directamente.
# Imprimir la lista resultante por pantalla.
dobles = []
for numero in [5, 10, 15]:
    dobles.append(2 * numero)
print(dobles)
